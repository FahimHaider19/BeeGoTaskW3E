...
<body>
	<div class="flex flex-col items-center mt-12 mx-4">
		...
		<form  method="GET" action="hotel" id="hotelui" class="relative bg-white grid grid-cols-2 px-2 sm:px-5 lg:px-8 py-10 shadow sm:rounded-lg max-w-4xl w-full">
			...
			<div class="relative flex flex-grow items-stretch focus-within:z-10">
				...
				<input datepicker datepicker-autohide type="text" name="hotelCheckInDate" id="hotelCheckInDate" class="block w-full py-5  bg-gray-100 rounded-none rounded-l-md border-gray-300 pl-10 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="John Smith">
			</div>
			<div class="relative flex flex-grow items-stretch focus-within:z-10">
				<div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
					<svg class="h-5 w-5 text-gray-400 bg-gray-100" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
				...
				<input datepicker datepicker-autohide type="text" name="hotelCheckOutDate" id="hotelCheckOutDate" class="block w-full py-5  bg-gray-100 rounded-none rounded-r-md border-gray-300 pl-10 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="John Smith">
			</div>
		...
		<form method="GET" action="flight" id="flightui" class="relative hidden bg-white grid grid-cols-2 px-2 sm:px-5 lg:px-8 py-10 shadow sm:rounded-lg max-w-4xl w-full">
			...
			<div class="my-2 mx-1">
				...
				<input type="text" name="location_from" id="location_from" class="block w-full bg-gray-100 rounded-md border-gray-300 pl-10 py-5 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Location From">
				</div>
			</div>
			<div class="my-2 mx-1">
				<div class="relative mt-1 rounded-md shadow-sm">
				...
				<input type="text" name="location_to" id="location_to" class="block w-full bg-gray-100 rounded-md border-gray-300 pl-10 py-5 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Location To">
				</div>
			</div>
			...
			<div id="departure_date_div" class="my-2 mx-1 col-span-2">
				<div class="flex rounded-md shadow-sm">
					<div class="relative flex flex-grow items-stretch focus-within:z-10">
						...
						<input datepicker datepicker-autohide type="text" name="departure_date" id="departure_date" class="block w-full py-5  bg-gray-100 rounded-md border-gray-300 pl-10 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="John Smith">
					</div>
				</div>
			</div>
			<div id="return_date_div" class="my-2 mx-1 hidden">
				<div class="flex rounded-md shadow-sm">
					<div class="relative flex flex-grow items-stretch focus-within:z-10">
						...
						<input datepicker datepicker-autohide type="text" name="return_date" id="return_date" class="block w-full py-5  bg-gray-100 rounded-md border-gray-300 pl-10 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="John Smith">
					</div>
				</div>
			</div>
